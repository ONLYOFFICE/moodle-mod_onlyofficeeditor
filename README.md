...
This plugin enables users to view, edit, and collaborate on office documents directly within [Moodle](https://moodle.org/) by connecting to [ONLYOFFICE Docs](https://www.onlyoffice.com/docs).

<p align="center">
  <a href="https://www.onlyoffice.com/office-for-moodle">
    <img width="800" src="https://static-site.onlyoffice.com/public/images/templates/office-for-moodle/documents/documents-1@2x.png" alt="ONLYOFFICE Docs for Moodle">
  </a>
</p>
...
* Edit text documents, spreadsheets, presentations, and PDF forms directly in Moodle.
* Collaborate on documents in real time with two co-editing modes (Fast and Strict), Track Changes mode, comments, and built-in chat.
...
An instance of ONLYOFFICE Docs (Document Server) version 4.2.7 or higher is required. It must be resolvable and accessible both from Moodle and client devices, and able to POST data to Moodle.
...
Follow the usual Moodle plugin installation steps to install this plugin into your __mod/onlyofficeeditor__ directory. Please see [Moodle Documentation](https://docs.moodle.org/501/en/Installing_plugins) for more information.

The latest compiled package files are available [here](https://github.com/ONLYOFFICE/moodle-mod_onlyofficeeditor/releases).

## Configuring ONLYOFFICE plugin for Moodle ⚙️
...
| ------------- | ------------- | ------------- |
| | [Get it now](https://www.onlyoffice.com/download-community?utm_source=github&utm_medium=cpc&utm_campaign=GitHubMoodle#docs-community)  | [Start Free Trial](https://www.onlyoffice.com/download?utm_source=github&utm_medium=cpc&utm_campaign=GitHubMoodle#docs-enterprise)  |
| Cost  | FREE  | [Go to the pricing page](https://www.onlyoffice.com/docs-enterprise-prices?utm_source=github&utm_medium=cpc&utm_campaign=GitHubMoodle)  |
...
* **🐞 Found a bug?** Please report it by creating an [issue](https://github.com/ONLYOFFICE/moodle-mod_onlyofficeeditor/issues).
