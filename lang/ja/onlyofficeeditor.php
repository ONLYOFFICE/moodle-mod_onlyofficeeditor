...
$string['conversionserviceerror'] = 'ONLYOFFICE Docs変換サービスの確認中にエラーが発生しました。システム管理者までご連絡ください。';
...
$string['mixedcontenterror'] = 'アクティブコンテンツの混在は許可されていません。ONLYOFFICE DocsにはHTTPSアドレスが必要です。';
