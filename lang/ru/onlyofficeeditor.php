...
$string['conversionserviceerror'] = 'При проверке службы конвертации документов ONLYOFFICE произошла ошибка. Обратитесь к системному администратору.';
...
$string['mixedcontenterror'] = 'Смешанное активное содержимое запрещено. Для ONLYOFFICE Docs необходимо использовать HTTPS-адрес.';
