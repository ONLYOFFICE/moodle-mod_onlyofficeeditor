...
$string['validationerror:docsinvalidurl'] = 'Неверный URL-адрес Сервера документов. Проверьте формат URL-адреса.';
...
$string['validationerror:invalidurl'] = 'Неверный URL-адрес. Проверьте формат URL-адреса.';
