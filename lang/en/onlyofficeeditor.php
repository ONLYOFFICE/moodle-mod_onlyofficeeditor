...
$string['conversionserviceerror'] = 'Error occurred while checking ONLYOFFICE Docs conversion service. Please check your plugin settings.';
...
$string['validationerror:emptyurl'] = 'Document Server URL cannot be empty.';
...
$string['checkdocserverbutton'] = 'Check Document Server';
