...
$string['conversionserviceerror'] = 'Se ha producido un error al comprobar el servicio de conversión de ONLYOFFICE Docs. Por favor, póngase en contacto con el administrador del sistema';
...
$string['mixedcontenterror'] = 'Contenido mixto activo no está permitido. Se requiere la dirección HTTPS para ONLYOFFICE Docs.';
